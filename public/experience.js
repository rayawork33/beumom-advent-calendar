(function(){
  ...
  story.innerHTML=`<div class="story-sticky"><div class="story-copy"><div class="story-kicker">A small scroll story</div><h2>The house has been preparing something for you.</h2><p>December asks you to carry so much. Here, each gift settles gently into place.</p></div><div class="story-sparkles" aria-hidden="true"><i>✦</i><i>·</i><i>✧</i><i>·</i><i>✦</i></div><div class="story-gifts">${[
