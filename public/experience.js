(function(){
  ...
  story.innerHTML=`<div class="story-sticky"><div class="story-copy"><div class="story-kicker">A small scroll story</div><h2>The house has been preparing something for you.</h2><p>December asks you to carry so much. Here, each gift settles gently into place.</p></div><div class="story-sparkles" aria-hidden="true"><i>✦</i><i>·</i><i>✧</i><i>·</i><i>✦</i></div><img class="story-botanicals botanical-left" src="./botanical-sprigs.png" alt="" aria-hidden="true"><img class="story-botanicals botanical-right" src="./botanical-sprigs.png" alt="" aria-hidden="true"><div class="story-gifts">${[
    ...
    ['8%','82px','108px','54px','#F1C580','18deg','-4deg'],['25%','91px','58px','92px','#D99055','-16deg','4deg'],['38%','112px','112px','54px','#9FAF97','20deg','-3deg'],['58%','100px','60px','96px','#E9A45E','-18deg','5deg'],['70%','104px','112px','52px','#C9B577','15deg','-4deg'],
    ['20%','164px','112px','48px','#E5AD68','-17deg','3deg'],['42%','174px','70px','76px','#71826B','19deg','-3deg'],['58%','166px','110px','50px','#E6C07A','-15deg','4deg'],
    ['43%','238px','76px','64px','#D98E55','17deg','-2deg']
  ].map((g,i)=>`<i class="fall-gift${i>4?' pile-gift':''}" style="--x:${g[0]};--y:${g[1]};--w:${g[2]};--h:${g[3]};--c:${g[4]};--rot:${g[5]};--settle:${g[6]||'0deg'};transition-delay:${i<5?i*.03:.16+(i-5)*.055}s"></i>`).join('')}</div><div class="story-finale">Twenty-four small gifts of care</div></div>`;
